import{_ as n,c as a,o as e,a2 as p}from"./chunks/framework.B7MVOZUf.js";const u=JSON.parse('{"title":"Nginx Base Configuration(nginx 基础)","description":"","frontmatter":{},"headers":[],"relativePath":"src/Middleware/Nginx/nginx-base.md","filePath":"src/Middleware/Nginx/nginx-base.md","lastUpdated":1737139361000}'),l={name:"src/Middleware/Nginx/nginx-base.md"};function r(i,s,c,o,t,b){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="nginx-base-configuration-nginx-基础" tabindex="-1">Nginx Base Configuration(nginx 基础) <a class="header-anchor" href="#nginx-base-configuration-nginx-基础" aria-label="Permalink to &quot;Nginx Base Configuration(nginx 基础)&quot;">​</a></h1><h2 id="_1-配置文件路径" tabindex="-1">1. 配置文件路径 <a class="header-anchor" href="#_1-配置文件路径" aria-label="Permalink to &quot;1. 配置文件路径&quot;">​</a></h2><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/etc/nginx/nginx.conf</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br></div></div><h2 id="_2-基本配置" tabindex="-1">2. 基本配置 <a class="header-anchor" href="#_2-基本配置" aria-label="Permalink to &quot;2. 基本配置&quot;">​</a></h2><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>user nginx;</span></span>
